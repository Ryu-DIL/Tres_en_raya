...
def get_text(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.after(5000, lambda: gb.destroy())
...
def AskToPlay(question):
	...
	board = [[" " for x in range(3)] for y in range(3)]
	sign = 0
	head = Button(menu, text = question,
				activeforeground = 'red',
				activebackground = "yellow", bg = "red",
				fg = "yellow", width = 500, font = 'summer', bd = 5)
	
	B1 = Button(menu, text = "Yes", command = jugar,
				activeforeground = 'red',
				activebackground = "yellow", bg = "red",
				fg = "yellow", width = 500, font = 'summer', bd = 5)	
	
	B2 = Button(menu, text = "No", command = menu.quit, activeforeground = 'red',
				activebackground = "yellow", bg = "red", fg = "yellow",
				width = 500, font = 'summer', bd = 5)
	head.pack(side = 'top')
	B1.pack(side = 'top')
...
if __name__ == '__main__':
	AskToPlay('Do you want to play? (Y/N): ')
